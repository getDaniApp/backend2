        ...
        <div class="card-body">
            ...
            <div class="row">
                <div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
                    ...
                    <!-- order_money_save Field -->
                    <div class="form-group row">
                        {!! Form::label('order_money_save', trans("lang.order_money_save"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('order_money_save', setting('order_money_save'),  ['class' => 'form-control','placeholder'=>  trans("lang.order_money_save_short_description_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.order_money_save_help") }}
                            </div>
                        </div>
                    </div>
                    
                    <!-- order_point_save Field -->
                    <div class="form-group row">
                        {!! Form::label('order_point_save', trans("lang.order_point_save"), ['class' => 'col-4 control-label text-right']) !!}
                        <div class="col-8">
                            {!! Form::text('order_point_save', setting('order_point_save'),  ['class' => 'form-control','placeholder'=>  trans("lang.order_point_save_short_description_placeholder")]) !!}
                            <div class="form-text text-muted">
                                {{ trans("lang.order_point_save_help") }}
                            </div>
                        </div>
                    </div>
