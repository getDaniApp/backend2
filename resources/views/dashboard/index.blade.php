            ...
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-info">
                    <div class="inner">
                        ...
                        <p>{{trans('lang.total_order')}}</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-shopping-bag"></i>
                    </div>
                    <a href="{!! route('orders.index') !!}" class="small-box-footer">{{trans('lang.more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-danger">
                    <div class="inner">
                        ...
                        <p>{{trans('lang.total_earn')}}<span style="font-size: 11px">{{trans('lang.after_taxes')}}</span></p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-money"></i>
                    </div>
                    <a href="{!! route('payments.index') !!}" class="small-box-footer">{{trans('lang.more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-success">
                    ...
                    <a href="{!! route('restaurants.index') !!}" class="small-box-footer">{{trans('lang.more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-3 col-6">
                ...
                <div class="small-box bg-warning">
                    <div class="inner">
                        ...
                        <p>{{trans('lang.total_clients')}}</p>
                    </div>
                    <div class="icon">
                        <i class="fa fa-group"></i>
                    </div>
                    <a href="{!! route('users.index') !!}" class="small-box-footer">{{trans('lang.more_info')}} <i class="fa fa-arrow-circle-right"></i></a>
                </div>
            </div>
            <!-- ./col -->
                ...
                <div class="card">
                    <div class="card-header no-border">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="{!! route('payments.index') !!}">{{trans('lang.view_all_pay')}}</a>
                        </div>
                    </div>
                    <div class="card-body">
                        <div class="d-flex">
                            <p class="d-flex flex-column">
                                ...
                                @endif
                                <span>{{trans('lang.earning_over_time')}}</span>
                            </p>
                            <p class="ml-auto d-flex flex-column text-right">
                                <span class="text-success"> {{$ordersCount}}</span></span> <span class="text-muted">{{trans('lang.earning_total_orders')}}</span>
                            </p>
                        </div>
                        <!-- /.d-flex -->
                        ...
                        <div class="d-flex flex-row justify-content-end">
                            <span class="mr-2"> <i class="fa fa-square text-primary"></i> {{trans('lang.this_year')}} </span>
                        </div>
                    </div>
                </div>
            </div>
