    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="form-group row col-6">
                    {!! Form::label('cash_on_delivery', trans('lang.cash_on_delivery'),['class' => 'col-4 control-label text-right']) !!}
                    <div class="checkbox icheck">
                        <label class="w-100 ml-2 form-check-inline">
                            {!! Form::hidden('cash_on_delivery', null) !!}
                            {!! Form::checkbox('cash_on_delivery', 1, setting('cash_on_delivery', false)) !!}
                            <span class="ml-2">{!! trans('lang.cash_on_delivery') !!}</span>
                        </label>
                    </div>
                </div>
