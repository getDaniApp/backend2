...
<div style="flex: 50%;max-width: 50%;padding: 0 4px;" class="column">
    ...
    <!-- delivery_fee Field -->
    <div class="form-group row ">
        {!! Form::label('order_time', trans("lang.order_time"), ['class' => 'col-3 control-label text-right']) !!}
        <div class="col-9">
            {!! Form::number('order_time', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_time")]) !!}
            <div class="form-text text-muted">
                {{ trans("lang.order_time") }}
            </div>
        </div>
    </div>
    <!-- Hint Field -->
