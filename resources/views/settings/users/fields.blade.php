...
@hasrole('admin')
    <!-- Wallet Field -->
<div class="form-group row ">
    {!! Form::label('wallet', trans("lang.order_money_save"), ['class' => 'col-3 control-label text-right']) !!}
    <div class="col-9">
        {!! Form::number('wallet', null,  ['class' => 'form-control','placeholder'=>  trans("lang.order_money_save")]) !!}
    </div>
</div>
...
<div class="form-group row ">
    ...
    <div class="col-9">
        {!! Form::number('point', null,  ['class' => 'form-control','placeholder'=>  trans("lang.food_point")]) !!}
    </div>
</div>
@endrole
</div>
